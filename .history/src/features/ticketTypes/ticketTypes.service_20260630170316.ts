...
import { ICreateTicketTypeDto, IUpdateTicketTypeDto } from "./dto/ticketType.dto";
...
export class TicketTypeService {
  ...
  async createTicketType(
    ...
    if (!["DRAFT", "PENDING"].includes(event.status))
      throw new AppError("Chỉ có thể thêm loại vé khi event ở trạng thái DRAFT hoặc PENDING", 400);
